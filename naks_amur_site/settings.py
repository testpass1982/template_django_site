"""
Django settings for naks_amur_site project.
...
SECRET_KEY = 'enc8+q14&-p5k3%qjhu)%b0wca3cse2nhx)g50ipgg1grq1j4!'

# SECURITY WARNING: don't run with debug turned on in production!
#DEBUG = False
DEBUG = True

# ALLOWED_HOSTS = ['naks_amur_site.minml.ru']
ALLOWED_HOSTS = ['*']
...
ROOT_URLCONF = 'naks_amur_site.urls'
...
WSGI_APPLICATION = 'naks_amur_site.wsgi.application'
